...
**Package**: `@trustvault/password-utils-react`  
...
├── packages/
│   ├── react/                          # @trustvault/password-utils-react
│   │   ├── src/
...
### Core Package (@trustvault/password-utils)
...
### React Package
- [ ] Link core package: `npm link @trustvault/password-utils`
- [ ] Run `npm run test`
- [ ] Run `npm run build`
